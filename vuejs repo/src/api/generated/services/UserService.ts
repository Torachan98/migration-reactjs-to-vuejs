...
export class UserService {
   ...
   * @throws ApiError
   */
  public static deleteApiUser({ guid }: { guid?: string }): CancelablePromise<BooleanApiResponse> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/User',
      query: {
   ...
   * @throws ApiError
   */
  public static getUserById({ id }: { id: string }): CancelablePromise<UserDTOApiResponse> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/api/User/{id}',
      path: {
